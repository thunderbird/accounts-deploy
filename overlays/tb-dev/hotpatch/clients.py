# =====================================================================================
# Stalwart v0.16 JMAP port (HOTPATCH) of src/thunderbird_accounts/mail/clients.py
# -------------------------------------------------------------------------------------
...
#
# Ground truth for shapes + endpoint wiring: STALWART_V016_PORT_NOTES.md
# Changed methods are marked with a `# v0.16 JMAP port` comment.
# =====================================================================================
